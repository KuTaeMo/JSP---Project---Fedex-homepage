...
<body id="page-top">
	...
	<nav
		...
		<div class="container">
			...
			<a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger headera"
					href="#contact">등록/로그인<img src="assets/img/bglogin.png" /></a>
				<a href="#"><img src="assets/img/searchicon.png"></a>
			<button
	...
	<header class="masthead text-black text-center">
		<div class="d-flex"
			style="background-image: URL(assets/img/mainbg.jpg); background-size: 100%; background-repeat: no-repeat;">
			<div class="container d-flex align-items-center flex-column"
				style="height: 600px">
				<!-- Masthead Heading-->
				<div style="padding-top: 100px; font-size: 50px">누구보다 먼저 발송을
					시작하세요</div>
				<!-- Icon Divider-->
				...
				<div>
					<div class="d-flex">
						<input type="text" name="trackingnumber" class="maininput"
							...
							style="font-weight: bold; padding-left: 10px; font-size: 12px; height:60px;">
		...
		<div class="container">
			<div class="d-flex">
				...
				<div>
					<h3>성수기에 대비하세요</h3>
					<div>
					비즈니스에 도움이 되는 여렁 유용한 정보들과 도구들을 활
					용해서 성수기에 누구보다 앞서 나가세요. FedEx는 역대 가
					장 많은 배송 뮬량에도 만반의 준비가 되어 있습니다.
					</div>
				</div>
				<!-- image -->
				<div>
	...
	<section class="page-section bg-primary text-white mb-0" id="test">
		<div class="container">
			<!-- About Section Heading-->
			<h2
				class="page-section-heading text-center text-uppercase text-white">test</h2>
			<!-- Icon Divider-->
			<div class="divider-custom divider-light">
				<div class="divider-custom-line"></div>
				<div class="divider-custom-icon">
